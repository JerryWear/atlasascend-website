    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        <FadeUp duration={1.2}>
          ...
          >
            &ldquo;I built Atlas Ascend because my clients deserved more than a
            spreadsheet and a WhatsApp message. They deserved a system that
            thinks like a coach, remembers everything, and shows up every
            single day.&rdquo;
          </blockquote>
        </FadeUp>
        ...
        <FadeUp delay={0.4} className="mt-10">
          ...
          <div className="font-inter text-gold text-sm mt-1">
            Founder, Atlas Ascend · 30+ Years Coaching
          </div>
          <div className="font-inter text-white-muted text-xs mt-2 leading-relaxed">
            Certified Personal Trainer · Nutrition Coach ·
            Mindfulness Practitioner · Competition Judge
          </div>
        </FadeUp>
      </div>
    </section>
